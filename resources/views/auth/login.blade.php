...
@section('content')
    <section class="relative w-full h-full py-40 min-h-screen">
        <div class="absolute top-0 w-full h-full bg-gray-900 bg-full bg-no-repeat" {{-- style="background-image: url('{{ asset('img/register_bg_2.png') }}');" --}}></div>
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="relative w-full mb-3">
                                    ...
                                    <input id="email" name="email" type="text"
                                        ...
                                        placeholder="{{ trans('global.login_email') }}" value="{{ __('admin@admin.com') }}">
                                ...
                                <div>
                                    <label class="inline-flex items-center cursor-pointer">
                                        ...
                                        <span
                                            class="ml-2 text-sm font-semibold text-gray-700">{{ trans('global.remember_me') }}</span>
                                    </label>
                                </div>
