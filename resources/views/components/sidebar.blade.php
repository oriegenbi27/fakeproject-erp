        ...
        <div class="md:flex md:flex-col md:items-stretch md:opacity-100 md:relative md:mt-4 md:shadow-none shadow absolute top-0 left-0 right-0 z-40 overflow-y-auto overflow-x-hidden h-auto items-center flex-1 rounded hidden"
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                ...
                @can('contact_management_access')
                    <li class="items-center">
                        <a class="has-sub {{ request()->is('admin/contact-companies*') || request()->is('admin/contact-contacts*') ? 'sidebar-nav-active' : 'sidebar-nav' }}"
                            href="#" onclick="window.openSubNav(this)">
                            <i class="fa-fw fas fa-users c-sidebar-nav-icon">
                            </i>
                        ...
                        <ul class="ml-4 subnav hidden">
                            @can('contact_company_access')
                                <li class="items-center">
                                    <a class="{{ request()->is('admin/contact-companies*') ? 'sidebar-nav-active' : 'sidebar-nav' }}"
                            ...
                            @can('contact_contact_access')
                                <li class="items-center">
                                    <a class="{{ request()->is('admin/contact-contacts*') ? 'sidebar-nav-active' : 'sidebar-nav' }}"
                ...
                @can('transaction_access')
                    <li class="items-center">
                        <a class="{{ request()->is('admin/transactions*') ? 'sidebar-nav-active' : 'sidebar-nav' }}"
                    ...
                    @can('profile_password_edit')
                        <li class="items-center">
                            <a href="{{ route('profile.password.edit') }}"
                                class="{{ request()->is('profile/password') || request()->is('profile/password/*') ? 'sidebar-nav-active' : 'sidebar-nav' }}">
