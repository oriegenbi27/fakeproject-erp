<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('contactContact.company_id') ? 'invalid' : '' }}">
        ...
        <x-select-list class="form-control" required id="company" name="company" :options="$this->listsForFields['company']"
            wire:model="contactContact.company_id" />
    ...
    <div class="form-group {{ $errors->has('contactContact.contact_first_name') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="contact_first_name" id="contact_first_name"
            wire:model.defer="contactContact.contact_first_name">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('contactContact.contact_last_name') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="contact_last_name" id="contact_last_name"
            wire:model.defer="contactContact.contact_last_name">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('contactContact.contact_phone_1') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="contact_phone_1" id="contact_phone_1"
            wire:model.defer="contactContact.contact_phone_1">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('contactContact.contact_phone_2') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="contact_phone_2" id="contact_phone_2"
            wire:model.defer="contactContact.contact_phone_2">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('contactContact.contact_email') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="contact_email" id="contact_email"
            wire:model.defer="contactContact.contact_email">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('contactContact.contact_skype') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="contact_skype" id="contact_skype"
            wire:model.defer="contactContact.contact_skype">
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('contactContact.contact_address') ? 'invalid' : '' }}">
        ...
        <input class="form-control" type="text" name="contact_address" id="contact_address"
            wire:model.defer="contactContact.contact_address">
        <div class="validation-message">
